      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-2xl font-bold text-[#1d305f]">Notifikasi</h1>
                ...
                >
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex-grow">
                      <p className="text-[#1d305f] font-medium">{notification.message}</p>
                      {notification.postId && (
                        <Link 
                          to={`/post/${notification.postId._id}`}
                          className="text-sm text-[#5b83c2] hover:text-[#1d305f] transition-colors mt-1 block"
                        >
